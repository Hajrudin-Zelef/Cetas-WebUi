...
DEFAULT_LSP_CONFIGS = {
    ...
    ".sh": {"command": ["bash-language-server", "start"], "language": "shellscript"},
    ".html": {"command": ["vscode-html-language-server", "--stdio"], "language": "html"},
    ".css": {"command": ["vscode-css-language-server", "--stdio"], "language": "css"},
    ".json": {"command": ["vscode-json-language-server", "--stdio"], "language": "json"},
