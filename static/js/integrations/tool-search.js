...
async function _execMarexcodeTool(e){
  ...
  var payload;
  if (tool === "bash") payload = { tool: "Bash", args: { command: String(args.command || "") } };
  else if (tool === "read") payload = { tool: "Read", args: { file_path: String(args.file_path || "") } };
  ...
  else if (tool === "grep") payload = { tool: "Grep", args: { pattern: String(args.pattern || ""), path: String(args.path || "") } };
