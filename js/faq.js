...
const FAQ_DATA = [
    ...
    },
    {
        ...
        answer: "<strong>Oui !</strong> Cetas prend en charge des fonctionnalités vocales bidirectionnelles :<ul><li><strong>Dictée (Speech-to-Text) :</strong> cliquez sur l'icône microphone pour dicter votre prompt. La transcription utilise la reconnaissance vocale de votre navigateur (gratuite, sans clé API) ou des modèles distants : OpenAI Whisper, OpenRouter Whisper, Google Gemini, Mistral Voxtral.</li><li><strong>Lecture (Text-to-Speech) :</strong> écoutez les réponses de l'IA à voix haute via la synthèse vocale de votre système ou les voix proposées par OpenAI, Google, Mistral et Nvidia.</li></ul>Le choix du fournisseur se fait dans <strong>Configuration > Fonctionnalités</strong>."
    },
    {
        category: 'learn',
